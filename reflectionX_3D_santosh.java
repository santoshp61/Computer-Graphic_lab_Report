...
public class reflectionX_3D_santosh extends JPanel {
    private int[][] originalCube = new int[8][2];
    private int[][] reflectedCube = new int[8][2];

    public reflectionX_3D_santosh(int[][] vertices) {
        for (int i = 0; i < 8; i++) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        drawCube(g, reflectedCube, Color.MAGENTA, "Reflected X", "CUBE RX", xOffset);
    }
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Santosh --> 3D Cube Reflection on X-axis");
        frame.add(new reflectionX_3D_santosh(vertices));
